...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {          
            ...
            HuffTree.data = encodedOutput;
            HuffTree.ConstructTree();
            Dictionary<byte, bool[]> HuffTable = new Dictionary<byte, bool[]>();
            HuffTable = traveseTree(HuffTree);
            List<bool> compreesedText = Compress(encodedOutput, HuffTable);
            string huffmanTree = Serialize(HuffTree.tree.data[0]);
